<script>
  ...
  const toggleRowFarmer = (i) => {
    if (filtered_farmer_loans[i].status == "interviewed") {
      value =
        (filtered_farmer_loans[i].requestedMin +
          filtered_farmer_loans[i].requestedMax) /
        2;
  ...
  const toggleRowSME = (i) => {
    if (filtered_sme_loans[i].status == "interviewed") {
      value =
        (filtered_sme_loans[i].requestedMin +
          filtered_sme_loans[i].requestedMax) /
        2;
  ...
  async function nextFarmerStage(i) {
    ...
    const response = await fetch(
      `${PUBLIC_API_GATEWAY_URL}/agent/loan/response/farmer/next`,
      {
        method: "POST",
        headers: {
    ...
    filtered_farmer_loans = farmer_loans;
    farmerOpenRow = -1;
    // location.reload();
  }
  async function nextSMEStage(i) {
    ...
    const response = await fetch(
      `${PUBLIC_API_GATEWAY_URL}/agent/loan/response/sme/next`,
      {
        method: "POST",
        headers: {
          "Content-Type": "application/json",
  ...
  async function rejectFarmer(i) {
    ...
    const response = await fetch(
      `${PUBLIC_API_GATEWAY_URL}/agent/loan/response/farmer/reject`,
      {
        method: "POST",
        headers: {
          "Content-Type": "application/json",
  ...
  async function rejectSME(i) {
    ...
    const response = await fetch(
      `${PUBLIC_API_GATEWAY_URL}/agent/loan/response/sme/reject`,
      {
        method: "POST",
        headers: {
          "Content-Type": "application/json",
  ...
  async function finalizeFarmer(i) {
    ...
    const response = await fetch(
      `${PUBLIC_API_GATEWAY_URL}/agent/loan/response/farmer/accept `,
      {
        method: "POST",
        headers: {
          "Content-Type": "application/json",
  ...
  async function finalizeSME(i) {
    ...
    const response = await fetch(
      `${PUBLIC_API_GATEWAY_URL}/agent/loan/response/sme/accept `,
      {
        method: "POST",
        headers: {
          "Content-Type": "application/json",
  ...
  $: filtered_farmer_loans = filtered_farmer_loans;
</script>
...
<div class="flex flex-row">
  ...
  <div class="w-full h-screen p-5">
    ...
    <Tabs
      style="underline"
      contentClass="p-4 bg-divider_col rounded-lg dark:bg-gray-800 mt-4 h-4/5"
    >
          ...
          {:else if filtered_farmer_loans.length == 0}
            ...
            >
              ...
              >
                <div class="flex flex-col items-center justify-center">
                  <span class="text-custom_font-table_header text-xl"
                    >No loans matching The filters</span
                  >
                  <LinkSlashSolid class="w-48 h-48 mt-4 text-gray-400" />
                </div>
              </TableBodyCell>
          ...
          {:else}
            {#each filtered_farmer_loans.slice(pagination_page_farmer*10, (pagination_page_farmer+1)*10+1) as loan, i}
              ...
              >
                ...
                >
                <TableBodyCell class="text-custom_font-table-header text-center"
                  >{loan.status[0].toUpperCase() +
                    loan.status.slice(1, loan.status.length)}</TableBodyCell
                >
              </TableBodyRow>
              {#if farmerOpenRow === i}
                <TableBodyRow
                ...
                >
                  <TableBodyCell colspan="8" class="p-0">
                    <div
                      class="flex flex-row w-full min-w-full space-x-5"
                      transition:slide={{ duration: 300, axis: "y" }}
                    >
                      <div class="grow p-2 h-full">
                        <span class="text-custom_font-table_header ms-4 mt-2"
                          >Loan Description</span
                        >
                        <div
                          class="px-2 py-3 border rounded-xl m-2 grow w-full h-24 flex-1"
                        >
                          <!-- <ImagePlaceholder /> -->
                          {loan.description}
                        </div>
                        ...
                        <Button
                          ...
                          on:click={() => {
                            if (
                              ...
                              nextFarmerStage(loan.request_id);
                          }}
                          size="md"
                        >
                          Next Stage
                ...
                <div class="flex flex-row items-center justify-between w-full">
                  ...
                  <p class="text-custom_font-table_header grow text-center">
                    ...
                    <span class="font-bold"
                      >{pagination_page_farmer * 10 + 1}</span
                    >
                    to
                    <span class="font-bold"
                      >{Math.min(
                        filtered_farmer_loans.length,
                  ...
                  <Button
                    ...
                    disabled={pagination_page_farmer >=
                      filtered_farmer_loans.length / 10 - 1}
                    class="text-xs bg-custom_font-sub_header text-white hover:bg-custom_font-light hover:drop-shadow-md disabled:invisible focus:ring-border_custom"
                  >
                    Next
                ...
                <div class="flex flex-row items-center justify-between w-full">
                  ...
                  <Button
                    ...
                    disabled={pagination_page_sme >=
                      filtered_sme_loans.length / 10 - 1}
                    class="text-xs bg-custom_font-sub_header text-white hover:bg-custom_font-light hover:drop-shadow-md disabled:invisible focus:ring-border_custom"
                  >
                    Next
                    <ChevronRightSolid class="w-4 h-4" />
    ...
    <Modal
      title={"Loan Request of " + detailsFarmer?.farmername}
      open={!!detailsFarmer}
      autoclose
      outsideclose
    >
          ...
          <TableBody>
            <TableBodyRow class="border-b-2 border-divider_col drop-shadow-md">
              ...
              <TableBodyCell class="text-custom_font-light"
                >{detailsFarmer.farmername}</TableBodyCell
              >
            </TableBodyRow>
            <TableBodyRow class="border-b-2 border-divider_col drop-shadow-md">
              ...
              >
              <TableBodyCell class="text-custom_font-light"
                >{detailsFarmer.farmerType}</TableBodyCell
              >
            </TableBodyRow>
            <TableBodyRow class="border-b-2 border-divider_col drop-shadow-md">
              <TableBodyCell class="text-custom_font-deep font-bold"
              ...
              >
              <TableBodyCell class="text-custom_font-light"
                >{detailsFarmer.points}</TableBodyCell
              >
            </TableBodyRow>
            <TableBodyRow class="border-b-2 border-divider_col drop-shadow-md">
              <TableBodyCell class="text-custom_font-deep font-bold"
              ...
              >
              <TableBodyCell class="text-custom_font-light"
                >{detailsFarmer.rank}</TableBodyCell
              >
            </TableBodyRow>
          </TableBody>
        </Table>
      ...
      <span class="ms-1 mt-3 text-custom_font-table_header"
        >Finalize Amount</span
      >
      <TripleSlider
        bind:value
        {values}
        min={detailsFarmer.requestedMin}
        max={detailsFarmer.requestedMax}
        minSlide={detailsFarmer.requestedMin - 1000}
        maxSlide={detailsFarmer.requestedMax + 1000}
      />
      <div class="flex flex-col p-2 space-y-4">
        <Button
          ...
          color="primary"
          on:click={() => {
            if (confirm("Are you sure you want to finalize the loan?"))
              finalizeFarmer(detailsFarmer.request_id);
          }}
          size="md"
        >
          Confirm
        ...
        <Button
          ...
          on:click={() => {
            if (confirm("Are you sure you want to reject the request?"))
              rejectFarmer(detailsFarmer.request_id);
          }}
        >
          Reject
        </Button>
    ...
    <Modal
      title={"Loan Request of " + detailsSME?.smename}
      open={!!detailsSME}
      autoclose
      outsideclose
    >
        ...
        <Table divClass="grow relative overflow-x-auto">
          <TableBody>
            <TableBodyRow class="border-b-2 border-divider_col drop-shadow-md">
              ...
              >
              <TableBodyCell class="text-custom_font-light"
                >{detailsSME.smename}</TableBodyCell
              >
            </TableBodyRow>
            <TableBodyRow class="border-b-2 border-divider_col drop-shadow-md">
              <TableBodyCell class="text-custom_font-deep font-bold"
              ...
              >
              <TableBodyCell class="text-custom_font-light"
                >{detailsSME.points}</TableBodyCell
              >
            </TableBodyRow>
            <TableBodyRow class="border-b-2 border-divider_col drop-shadow-md">
              <TableBodyCell class="text-custom_font-deep font-bold"
      ...
      <TripleSlider
        bind:value
        {values}
        min={detailsSME.requestedMin}
        max={detailsSME.requestedMax}
        minSlide={detailsSME.requestedMin - 1000}
        maxSlide={detailsSME.requestedMax + 1000}
      />
      <div class="flex flex-col p-2 space-y-4">
        <Button
          class="mt-7 w-full rounded-br-xl rounded-tr-xl"
          ...
          on:click={() => {
            if (confirm("Are you sure you want to finalize the loan?"))
              finalizeSME(detailsSME.request_id);
          }}
          size="md"
        >
          Confirm
        ...
        <Button
          ...
          on:click={() => {
            if (confirm("Are you sure you want to reject the request?"))
              rejectSME(detailsSME.request_id);
          }}
        >
          Reject
        </Button>
