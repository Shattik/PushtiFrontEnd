...
<h3 class="mb-1 text-xl font-medium text-custom_font-deep text-center dark:text-white">Create a Sell Request</h3>
        {#if farmerError}
        ...
        {#if selectedFarmer}
            ...
            <div class="text-sm flex flex-col p-4 py-4 w-full border-2 rounded-lg border-divider_col">
                <div class="flex flex-row p-3 px-6 border-b-2 border-divider_col bg-body_custom">
                    ...
                    <div class="text-custom_font-table-header text-right">{sellRequestFarmer.total}</div>
                </div>
                ...
                <div class="flex flex-row p-3 px-6 border-t-2 border-divider_col bg-body_custom">
                    ...
                    <div class="text-custom_font-table-header text-right">{sellRequestFarmer.finalAmount}</div>
                </div>
            </div>
        {/if}
